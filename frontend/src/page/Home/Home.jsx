                ...
                <>
                    ...
                    <div className="rounded-xl shadow-3xl px-[20px] bg-white py-[20px] h-[90%] flex flex-wrap">
                        ...
                        <div className="w-[50%] px-[20px]">
                            <h1 className="text-[28px] font-normal mb-5">Latest Access</h1>
                            {turn.data.data[0].person ? (
                                <>
                                    {' '}
                            ...
                            {turn.data.data[0].isMasked ? (
                                <b className="text-[20px] text-lime-500">Masked</b>
                            ) : (
                                <b className="text-[20px] text-red-500">No Masked</b>
                            )}
                            <p className="text-[20px]">
                                <b>Access Time: </b>
